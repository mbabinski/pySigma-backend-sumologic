...
from sigma.pipelines.sumologic import # TODO: add pipeline imports or delete this line
import sigma
import re
from typing import ClassVar, Dict, Tuple, Pattern, List, Any

class sumologicBackend(TextQueryBackend):
    """sumologic backend."""
    ...
    name : ClassVar[str] = "sumologic backend"
    formats : Dict[str, str] = {
        "default": "Plain sumologic queries",
        
        
        "logsearch": "'logsearch' output format",
        
        "cse_query": "'cse_query' output format",
    ...
    def finalize_query_logsearch(self, rule: SigmaRule, query: str, index: int, state: ConversionState) -> Any:
        # TODO: implement the per-query output for the output format logsearch here. Usually, the generated query is
        # embedded into a template, e.g. a JSON format with additional information from the Sigma rule.
        # TODO: proper type annotation.
        return query

    def finalize_output_logsearch(self, queries: List[str]) -> Any:
        # TODO: implement the output finalization for all generated queries for the format logsearch here. Usually,
    ...
    def finalize_query_cse_query(self, rule: SigmaRule, query: str, index: int, state: ConversionState) -> Any:
        # TODO: implement the per-query output for the output format cse_query here. Usually, the generated query is
        # embedded into a template, e.g. a JSON format with additional information from the Sigma rule.
        # TODO: proper type annotation.
        return query

    def finalize_output_cse_query(self, queries: List[str]) -> Any:
        # TODO: implement the output finalization for all generated queries for the format cse_query here. Usually,
        # the single generated queries are embedded into a structure, e.g. some JSON or XML that can be imported into
        # the SIEM.
        # TODO: proper type annotation. Sigma CLI supports:
        # - str: output as is.
