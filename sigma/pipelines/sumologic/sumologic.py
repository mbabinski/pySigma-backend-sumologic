...
def sumologic_example() -> ProcessingPipeline:      # Processing pipelines should be defined as functions that return a ProcessingPipeline object.
    return ProcessingPipeline(
        name="sumologic example pipeline",
        ...
        items=[
            ProcessingItem(     # This is an example for processing items generated from the mapping above.
                identifier=f"sumologic_windows_{service}",
            ...
            ProcessingItem(     # Field mappings
                identifier="sumologic_field_mapping",
